...
<div class="col-md-5">
    <div class="form-area">
        <form role="form" method="post" action="{{URL('updatemamber', $edit_Member->member_id)}}" enctype="multipart/form-data" >
       ...
       <?php
        ...
        <div class="form-group">
           <input type="text" value="{{$edit_Member->member_name}}" class="form-control" id="name" name="member_name"  required>
        </div>
        ...
        <div class="form-group">
          <img src="{{URL($edit_Member->member_image)}}" height="150px;" width="150px;" alt="">
        ...
        <div class="form-group">
        <textarea class="form-control" name="member_detels" type="textarea" id="message" placeholder="Enter Member  Description"   rows="7">{{$edit_Member->member_detels}}</textarea>
        </div>

        <label style="text-align:left;width:100%;">Member Post</label>
        <div class="form-group">
            <select  class="form-control" name="member_type"  >
              @if($edit_Member->member_type==1)
