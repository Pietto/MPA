@extends('welcome')
 @section('title')
     ...
     $images = DB::table('seo')->where('website_id' ,'1')->first(); ?>
      <title>Locat service || {{$allservice->service_title}} || mitfarm</title>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
         ...
         if($massage){  ?>
          ...
          <?php   Session::put('massage',NULL); } ?>
                            ...
                            <div class="comment-form-wrapper">
                                <div class="row">
                                    <form action="{{route('Commert-Local-Service-mitfarm',$allservice->service_id)}} " method="post">
                                        {{csrf_field()}}
                                    <div class="col-md-6">
    ...
    foreach($allservice as $vservice){    ?>
                                <div class="single-latest-posts">
                                    ...
                                    <div class="thumb">
                                     <a href="{{route('Local-Service-Detels-Page-mitfarm',$vservice->service_id)}} "> <img src="{{URL($vservice->service_image)}}" height="60px;" width="60px;" alt=""> </a>
                                    </div>
                                    <div class="content">
                                        
                                       <a href="{{route('Local-Service-Detels-Page-mitfarm',$vservice->service_id)}} "> <h4 class="title">{{$vservice->service_title}}</h4></a>
