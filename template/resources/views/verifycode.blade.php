	 ...
	 <div class="registration">
         ...
         if($massage){  ?>
          ...
          <?php   Session::put('massage',NULL); } ?> 
			 ...
			 <!-- Form -->
				<form id="registration_form" action="{{route('vefriy-Customer-mitfarm')}} " method="post">
					 {{csrf_field()}}
					<div>
						<label>
							<input name="code" required="" placeholder="Code Address" type="text" tabindex="1" required autofocus>
						</label>
					</div>
					<div>
						<label>
							<input type="password" name="customer_password" placeholder="Enter Password"   tabindex="2" required autofocus>
						</label>
					</div>
